...
const paths = {
	...
	scripts: 'assets/js/',
	html: '',
	domain: 'localhost/verona/' // your local domain, e.g. http://local.mysite; required for local development (browserSync) and for generate critical CSS
}
...
export { paths, sync, settingsAutoprefixer, critical, criticalSrcPages };
