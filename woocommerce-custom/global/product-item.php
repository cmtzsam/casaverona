...
<div class="box_product_item productCard">

	<!-- main image -->
	<div class="position-relative productCard--img">
		...
		<ul class="list flex-column label_product_list">
			...
			<?php if (in_array('new', $starter_term_array, true)) : ?>
				<li>
					<div class="wrap_label"><?php esc_html_e('New', 'starter'); ?></div>
				</li>
			<?php endif; ?>
			<?php if ($product->is_on_sale()) : ?>
				<li>
					<div class="wrap_label"><?php echo starter_get_svg(array('icon' => 'bi-percent')); ?></div>
				</li>
			<?php endif; ?>
		</ul>
	</div>
	...
	<div class="description_block productCard--desc">
		<div class="top_part_description">
			...
			if ($terms && ! is_wp_error($terms)) :
				$first_term = $terms[0];
			?>
				<p class="product-category"><?php echo esc_html($first_term->name); ?></p>
			<?php endif; ?>
			...
			<?php else : ?>
				<span><?php esc_html_e('Agotado', 'starter'); ?></span>
			<?php endif; ?>
			<!-- END price -->

			<div class="productCard--btns">
				...
				<?php if (is_plugin_active('ti-woocommerce-wishlist/ti-woocommerce-wishlist.php') && tinv_get_option('add_to_wishlist_catalog', 'show_in_loop')) : ?>
					<div class="productCard--wishList">
						<div class="wrap_label"><?php echo do_shortcode('[ti_wishlists_addtowishlist loop=yes]'); ?></div>
					</div>
				<?php endif; ?>
