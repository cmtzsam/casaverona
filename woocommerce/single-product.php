		...
		<div class="content_wrapper pt-5 pb-5" role="main">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 wrap_single_images">
						...
						<div class="productgridslide">
							...
							<div class="elcarrusel">
								<!-- js_zoom_wrap -->
								<div class="swiper position-relative mb-2 js_singlepage_img_carousel ">
									<div class="swiper-wrapper">
										<?php foreach ($starter_single_images as $starter_single_image) : ?>
					...
					<!-- right part -->
					<div class="col-md-6 dataprodint">

						<div class="dataprodint--info">
							...
							if ($terms && ! is_wp_error($terms)) :
								...
								foreach ($terms as $term) {
									...
									if (! is_wp_error($term_link)) {
										$category_links[] = '<a href="' . esc_url($term_link) . '" class="text-decoration-none text-dark">' . esc_html($term->name) . '</a>';
									}
								}
						...
						<h1><?php the_title(); ?></h1>
						<ul class="list single_tool_list d-none">
						...
						<div class="dataprodint--pricegrid">
						...
						<h6 class="pt-4 pb-2 mt-4 mb-0">DESCRIPCIÓN</h6>
						<div class="prod_desc">
							<?php the_content(); ?>
						</div>
